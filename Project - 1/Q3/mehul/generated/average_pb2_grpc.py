...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Average = channel.unary_unary(
                ...
                request_serializer=average__pb2.AverageRequest.SerializeToString,
                response_deserializer=average__pb2.AverageResponse.FromString,
                _registered_method=True)
        self.RunningAverage = channel.stream_unary(
                '/average.Calculator/RunningAverage',
                request_serializer=average__pb2.NumberRequest.SerializeToString,
                response_deserializer=average__pb2.AverageResponse.FromString,
                _registered_method=True)
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Average': grpc.unary_unary_rpc_method_handler(
                    servicer.Average,
                    request_deserializer=average__pb2.AverageRequest.FromString,
                    response_serializer=average__pb2.AverageResponse.SerializeToString,
            ),
            'RunningAverage': grpc.stream_unary_rpc_method_handler(
                    servicer.RunningAverage,
                    request_deserializer=average__pb2.NumberRequest.FromString,
                    response_serializer=average__pb2.AverageResponse.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def Average(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/average.Calculator/Average',
            average__pb2.AverageRequest.SerializeToString,
            average__pb2.AverageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def RunningAverage(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/average.Calculator/RunningAverage',
            average__pb2.NumberRequest.SerializeToString,
            average__pb2.AverageResponse.FromString,
            options,
            channel_credentials,
            insecure,
