...
def add_SwimServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BroadcastFailure': grpc.unary_unary_rpc_method_handler(
                    servicer.BroadcastFailure,
